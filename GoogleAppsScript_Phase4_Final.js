/* ================================================================
   ...
   Versi: 6.0 (FINAL - Bug Fixes & Perfect Prompts)
   ================================================================ */
...
function routerAgent(pesan, isOwner, history) {
  let sys = `You are an Intent Classifier Agent. Analyze the conversation history and the latest message.
Rules:
...
[KATALOG]: ${katalog}
[FAQ]: ${faq}
3. If they want to order, enthusiastically help them and tell them to provide their address.
...
`;
  ...
  if (result.sku_ditemukan && result.sku_ditemukan !== "SKU_JIKA_ADA") {
